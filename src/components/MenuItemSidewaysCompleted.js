...
export default function MenuItemSidewaysCompleted({ style, ...props }) {
  return (
    <View
      style={{
    ...
    >
      ...
      <View style={{ flexDirection: "row", height: "auto" }}>
        <View style={{ marginRight: 12 }}>
          <CMutedButtonHalf>Leave Review</CMutedButtonHalf>
        </View>

        <CPrimaryButtonHalf>Order Again</CPrimaryButtonHalf>
      </View>
    </View>
  );
}
